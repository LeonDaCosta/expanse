...
<div class="<?php echo $c->getPageWrapperClass()?>">
 <div class="header">
	...
	<!-- start search-->
		...
		<div class="logo">
			<a href="/"><img src="<?= $view->getThemePath() ?>/images/logo.png" alt=""><span>E</span>NLIGHTEN</a>
	    </div>
		<div class="banner">
...
<!--footer-->
	<div class="footer w3layouts-agile">
				<div class="container">
					<p class="footer-class">&copy; <?php Date('Y') ?> Enlighten. All Rights Reserved | Design by  <a href="" target="_blank">W3layouts</a> </p>
					<section id="set-9">
